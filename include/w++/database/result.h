    ...
    namespace db {
        ...
        class field
            ...
            public:
                ...
                operator unsigned int() const { return std::stoul(*this); }
                operator long long() const { return std::stoll(*this); }
                operator unsigned long long() const { return std::stoull(*this); }
                ...
                field& operator=(const field& rhs) { std::string::operator=(rhs); return *this; };
                field& operator=(const std::string& rhs) { std::string::operator=(rhs); return *this; };
        ...
        class row
            ...
            public:
                ...
                reference       operator[](const std::string &s) {return vector<field>::operator[](this->column_number(s.c_str()));}
                const_reference operator[](const std::string &s) const {return vector<field>::operator[](this->column_number(s.c_str()));}

                template <int N>
                reference       operator[](const char (&f)[N]) {return vector<field>::operator[](this->column_number(f));}
                template <int N>
                const_reference operator[](const char (&f)[N]) const {return vector<field>::operator[](this->column_number(f));}
                ...
                const_reference at(const std::string &s) const {return vector<field>::at(this->column_number(s.c_str()));}
                ...
                size_t column_number(const char column_name[]) const {
                    return std::find_if(this->_columns.begin(), this->_columns.end(), [column_name](std::shared_ptr<std::string> const &x){return (x) ? *x == column_name : false;}) - this->_columns.begin();
                }
