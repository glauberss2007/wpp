...
int main(int argc, char* argv[])
{
    ...
    std::string text = "Now is the time for all good men to come to the aide of their country";
    secure_string ptext = std::move(text.c_str());
